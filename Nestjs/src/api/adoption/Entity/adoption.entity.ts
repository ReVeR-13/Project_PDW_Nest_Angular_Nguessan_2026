...
@Entity({ name: 't_adoption' })
export class AdoptionEntity {

    @PrimaryColumn({ name: 'id_adoption', type: 'varchar', nullable: false })
    id: string;
    ...
    @Column({ name: 'statut', type: 'enum', nullable: false, enum:StatutValidation, enumName:'e_statut_adoption' })
